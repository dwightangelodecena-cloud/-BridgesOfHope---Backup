...
import { LayoutGrid, Users, TrendingUp, TrendingDown, Minus, AlertTriangle, Clock, Heart, ChevronUp, Calendar, FileText, ClipboardCheck } from 'lucide-react';
...
export default function NurseDashboardPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── MAIN CONTENT ── */}
      <main className="admin-sidebar-offset" style={{ padding: '24px 28px 40px', background: '#F8FAFF', overflowX: 'hidden' }}>
