...
const AdminDashboard = () => {
  ...
  return (
    <div
      className="family-portal admin-portal-layout dashboard-outer"
      style={{ display: 'flex', minHeight: '100vh', background: '#F8F9FD', fontFamily: "'Inter', -apple-system, sans-serif", color: '#1B2559', ...familySidebarStyle(isExpanded) }}
    >
      <style>{`
      ...
      {/* MAIN CONTENT */}
      <main className="dashboard-main admin-sidebar-offset">
