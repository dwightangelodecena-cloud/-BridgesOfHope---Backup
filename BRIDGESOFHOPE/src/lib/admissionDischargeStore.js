...
export function buildAdmissionRow(admissionRow, patientRow, override) {
  ...
  return {
    ...
    vitalsWeight: admissionRow.vitals_weight || '',
    vitalsHeight: admissionRow.vitals_height || '',
    vitalsBmi: admissionRow.vitals_bmi || '',
    vitalsBp: admissionRow.vitals_bp || '',
    vitalsPr: admissionRow.vitals_pr || '',
    vitalsRr: admissionRow.vitals_rr || '',
    vitalsTemperature: admissionRow.vitals_temperature || '',
    vitalsSpo2: admissionRow.vitals_spo2 || '',
    vitalsRecordedAt: admissionRow.vitals_recorded_at || null,
    preAdmissionSummary: admissionRow.pre_admission_summary || '',
