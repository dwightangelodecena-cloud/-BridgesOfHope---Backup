...
const styles = StyleSheet.create({
  ...
  cardV2Initials: { fontSize: 15, fontWeight: '900', color: '#4338CA' },
  ...
  modalHeroName: { fontSize: 19, fontWeight: '900', color: '#FFFFFF', letterSpacing: -0.3 },
  ...
  name: { fontSize: 14.5, fontWeight: '800', color: '#1B2559', flex: 1, minWidth: 120 },
  ...
  detailHeroName: { fontSize: 19, fontWeight: '900', color: '#1B2559' },
