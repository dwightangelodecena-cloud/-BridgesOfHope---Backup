...
export default function ChangePasswordScreen() {
  ...
  const goToProfile = () => goBackOrReplace(router, TAB_ROUTES.profile);
    ...
    <View style={styles.root}>
      ...
      <View style={[styles.hero, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.heroContent}>
          ...
          <Text style={styles.heroTitle}>Change your password</Text>
          ...
          >
            <View style={styles.formHeader}>
              <View style={styles.stepBadge}>
                <Text style={styles.stepBadgeText}>SECURITY</Text>
              </View>
              <Text style={styles.formTitle} accessibilityRole="header">
                Create a new password
              </Text>
              <Text style={styles.formSubtitle}>
                Use a unique password you haven&apos;t used elsewhere. You&apos;ll stay signed in
                after updating.
              </Text>
            </View>
            ...
            <View style={styles.howItWorks}>
              <View style={styles.howItWorksHeader}>
                ...
                <Text style={styles.howItWorksTitle}>Password safety</Text>
              </View>
              {SAFETY_TIPS.map((line, i) => (
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalMessage}>
              Your password has been changed successfully. You&apos;re still signed in on this device.
            </Text>
            <ScalePressable
              onPress={() => {
